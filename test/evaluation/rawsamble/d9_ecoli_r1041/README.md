# Rawsamble - d9_ecoli_r1041

We assume your current directory points to this directory ([`d9_ecoli_r1041`](./)) and your binary containing the Rawsamble functionality is in your `$PATH` and called `rawhash2`.
