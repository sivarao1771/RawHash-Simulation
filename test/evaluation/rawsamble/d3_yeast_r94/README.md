# Rawsamble - d3_yeast_r94

We assume your current directory points to this directory ([`d3_yeast_r94`](./)) and your binary containing the Rawsamble functionality is in your `$PATH` and called `rawhash2`.
