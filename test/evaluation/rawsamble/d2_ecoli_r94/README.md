# Rawsamble - d2_ecoli_r94

We assume your current directory points to this directory ([`d2_ecoli_r94`](./)) and your binary containing the Rawsamble functionality is in your `$PATH` and called `rawhash2`.
